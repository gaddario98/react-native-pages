...
declare const ShopifyView: <F extends FieldValues, Q extends QueriesArray>({ withoutPadding, body, itemForPage, onEndReached: baseOnEndReached, }: CustomScrollViewProps<F, Q>) => import("react/jsx-runtime").JSX.Element;
